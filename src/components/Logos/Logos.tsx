...
import { Container, Spacer, Heading, Content } from '../index';
...
export const Logos: React.FC<Logos> = ({
  ...
  const { title } = content;
  const spaceBetween = parseFloat(components.grid.gap) * 16;
  return (
    <section>
      <Spacer size="md" />
      <Container size="md">
      ...
      <StyledSwiper spaceBetween={spaceBetween} slidesPerView={6}>
