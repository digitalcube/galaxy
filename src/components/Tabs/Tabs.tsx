...
export const Tabs: FC<Tabs> = ({ children }: Tabs) => {
      ...
      <div className="tabset">
        ...
        <div className="tab-panels">
          ...
          <section id="dunkles" className="tab-panel">
            ...
            <p>
              <strong>History:</strong> Originated in the Northern German city
              of Einbeck, which was a brewing center and popular exporter in the
...
const StyledTabs = styled(Tabs)<Tabs>`
  background: orange;
`;
