        ...
        <Section className="md:flex min-h-screen border-t border-shifter-gray-200">
          <Aside items={menus} name={`{name}`} />
              <Switch>
                ...
                <Route path={`/${admin}/${sites}/:siteId/live/analytics`} component={PageSiteAnalytics} />
                ...
                <Route path={`/${admin}/${sites}/:siteId/dev/access-logs`} component={PageSiteAccessLogs} />
                <Route path={`/${admin}/${sites}/:siteId/dev/basic-auth`} component={PageSiteBasicAuth} />
                <Route path={`/${admin}/${sites}/:siteId/dev/emergency-actions`} component={PageSiteEmergencyAction} />
                <Route path={`/${admin}/${sites}/:siteId/dev/errors`} component={PageSiteErrors} />
